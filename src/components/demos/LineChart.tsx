  ...
  return (
    <figure className="not-prose m-0">
      ...
      <details className="group mt-4">
        <summary className="inline-flex min-h-11 cursor-pointer list-none items-center gap-2 font-mono text-[0.6875rem] tracking-[0.12em] text-fg-3 uppercase transition-all hover:brightness-150 sm:min-h-0">
          <svg
            aria-hidden
            viewBox="0 0 12 12"
